...
export class PromocionComponent implements OnInit {
  ...
  sin_promocion(){
    ...
    var tam =this.stringObject.productos[0].info.length;
     for (var i= 0; i < tam ; i++ ){
       if(this.stringObject.productos[0].info[i]["promocion"] == 1 ){
  ...
  sin_promocion2(){
    ...
    var tam =this.stringObject.productos[1].info.length;
     for (var i= 0; i < tam ; i++ ){
       if(this.stringObject.productos[1].info[i]["promocion"] == 1 ){
  ...
  sin_promocion3(){
    ...
    var tam =this.stringObject.productos[2].info.length;
     for (var i= 0; i < tam ; i++ ){
       if(this.stringObject.productos[2].info[i]["promocion"] == 1 ){
  ...
  anadir(){
    ...
    for ( var i = 0 ; i <(this.stringObject.productos[indice].info).length ;i++){
      if(this.stringObject.productos[indice].info[i]["promocion"] == 1){
      ...
      console.log("Datos almacenados son: "+aux);
